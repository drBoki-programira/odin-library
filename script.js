...
Book.addToLibrary(
  new Book("A Game of Thrones", "George R.R. Martin", 695, true)
);
...
titleInput.addEventListener("input", function () {
  ...
  if (!titleInput.validity.valid) {
    titleInput.setCustomValidity("You need to enter book title.");
  }
});
authorInput.addEventListener("input", function () {
  authorInput.setCustomValidity("");
  if (!authorInput.validity.valid) {
    authorInput.setCustomValidity("You need to enter author's name.");
  }
});
